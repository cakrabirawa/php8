...
<head>
    ...
    <title id="page-title">@yield('title', 'Dashboard App')</title>
    ...
    <div class="flex h-screen overflow-hidden relative">
        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                <a href="{{ url('/') }}"
                    class="sidebar-link ajax-link flex items-center px-4 py-3 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-900 transition {{ Request::is('/') ? 'bg-blue-600 text-white' : 'text-slate-400' }}">
                    <span class="mr-3">📊</span> Beranda
                </a>
                <a href="{{ url('/produk') }}"
                    class="sidebar-link ajax-link flex items-center px-4 py-3 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-900 transition {{ Request::is('produk') ? 'bg-blue-600 text-white' : 'text-slate-400' }}">
                    <span class="mr-3">📦</span> Manajemen Produk
                </a>
                <a href="{{ url('/pengguna') }}"
                    class="sidebar-link ajax-link flex items-center px-4 py-3 rounded-lg hover:bg-slate-800 dark:hover:bg-slate-900 transition {{ Request::is('pengguna') ? 'bg-blue-600 text-white' : 'text-slate-400' }}">
