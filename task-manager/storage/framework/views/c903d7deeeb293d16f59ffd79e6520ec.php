...
<style>
    ...
    @media (min-width: 769px) {
        .cu-info-panel { position: sticky; top: 14px; }
    }
...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            <a href="<?php echo e(route('projects.show', $project)); ?>" class="me-3 text-decoration-none">
    ...
    <div class="cu-layout">
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                <div class="cu-project-avatar" style="background:<?php echo e($projectColor); ?>;">
                    <?php echo e(strtoupper(substr($project->name, 0, 1))); ?>

                </div>
                <div class="cu-project-name"><?php echo e($project->name); ?></div>
                <div class="text-center mb-2">
                    <span class="cu-status-badge <?php echo e($statusInfo['class']); ?>">
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Start&nbsp;<strong><?php echo e(\Carbon\Carbon::parse($project->start_date)->format('M d, Y')); ?></strong></span>
                </div>
                <?php endif; ?>
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Due&nbsp;<strong><?php echo e(\Carbon\Carbon::parse($project->end_date)->format('M d, Y')); ?></strong></span>
                </div>
                <?php endif; ?>
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Budget&nbsp;<strong>$<?php echo e(number_format($project->budget, 0)); ?></strong></span>
                </div>
                <?php endif; ?>

                <div class="cu-meta-row">
                    <i class="bi bi-clock-history"></i>
                    <span>Updated&nbsp;<strong><?php echo e($project->updated_at->diffForHumans()); ?></strong></span>
                </div>

                <div class="cu-meta-row">
                    <i class="bi bi-person"></i>
                    <span>Owner&nbsp;<strong><?php echo e(auth()->user()->name); ?></strong></span>
                </div>
            </div>
        </div>

        
        <form action="<?php echo e(route('projects.update', $project)); ?>" method="POST" id="editProjectForm">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-input-wrap">
                                ...
                                <input type="text"
                                       name="name"
                                       id="name"
                                       class="cu-input <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-editor-wrap">
                                ...
                                <textarea name="description" id="description" style="display:none;"><?php echo e(old('description', $project->description)); ?></textarea>
                            </div>
                            ...
                            <div class="cu-field" style="margin-bottom:0;">
                                ...
                                <div class="cu-input-wrap">
                                    ...
                                    <input type="date"
                                           name="start_date"
                                           id="start_date"
                                           class="cu-input <?php echo e($errors->has('start_date') ? 'is-invalid' : ''); ?>"
                                           value="<?php echo e(old('start_date', $project->start_date ? \Carbon\Carbon::parse($project->start_date)->format('Y-m-d') : '')); ?>">
                                </div>
                            ...
                            <div class="cu-field" style="margin-bottom:0;">
                                ...
                                <div class="cu-input-wrap">
                                    ...
                                    <input type="date"
                                           name="end_date"
                                           id="end_date"
                                           class="cu-input <?php echo e($errors->has('end_date') ? 'is-invalid' : ''); ?>"
                                           value="<?php echo e(old('end_date', $project->end_date ? \Carbon\Carbon::parse($project->end_date)->format('Y-m-d') : '')); ?>">
                                </div>
                        ...
                        <div class="cu-field" style="margin-bottom:0; margin-top:12px;">
                            ...
                            <div class="cu-input-wrap">
                                ...
                                <input type="number"
                                       name="budget"
                                       id="budget"
                                       class="cu-input <?php echo e($errors->has('budget') ? 'is-invalid' : ''); ?>"
                                       value="<?php echo e(old('budget', $project->budget)); ?>"
                                       step="0.01" min="0"
                                       placeholder="0.00">
                            </div>
                        ...
                        <div class="cu-status-chips">
                            <div class="cu-chip-option chip-not-started">
                                <input type="radio" name="status" id="status_not_started" value="not_started"
                                    <?php echo e(old('status', $project->status) == 'not_started' ? 'checked' : ''); ?>>
                            ...
                            <div class="cu-chip-option chip-in-progress">
                                <input type="radio" name="status" id="status_in_progress" value="in_progress"
                                    <?php echo e(old('status', $project->status) == 'in_progress' ? 'checked' : ''); ?>>
                            ...
                            <div class="cu-chip-option chip-completed">
                                <input type="radio" name="status" id="status_completed" value="completed"
                                    <?php echo e(old('status', $project->status) == 'completed' ? 'checked' : ''); ?>>
                            ...
                            <div class="cu-chip-option chip-closed">
                                <input type="radio" name="status" id="status_closed" value="closed"
                                    <?php echo e(old('status', $project->status) == 'closed' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cu-action-bar">
                        <a href="<?php echo e(route('projects.show', $project)); ?>" class="cu-btn-cancel">Cancel</a>
    ...
    <div class="cu-section cu-danger-section" style="margin-top:10px; border-color:#fecaca;">
        ...
        <div class="cu-section-body">
            ...
            <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" id="deleteForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/projects/edit.blade.php ENDPATH**/ ?>