...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center justify-content-between" style="position:relative;z-index:1;">
            ...
            <a href="<?php echo e(route('notes.create')); ?>" class="cu-btn-new">
    ...
    <div class="cu-stats">
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val" id="stat-total"><?php echo e($notes->count()); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($notes->where('is_favorite', true)->count()); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($categories->count()); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e(number_format($notes->sum('word_count'))); ?></div>
    ...
    <div class="cu-filter-bar">
        <div class="cu-search-wrap">
            ...
            <input type="text" class="cu-search" id="search" placeholder="Search notes..." value="<?php echo e(request('search')); ?>">
        </div>
        ...
        <button type="button" class="cu-fav-toggle <?php echo e(request('favorites') == '1' ? 'active' : ''); ?>" id="fav-toggle">
            <i class="bi bi-star-fill"></i> Favorites
        </button>
        <span class="cu-count-badge" id="notes-count"><?php echo e($notes->count()); ?> notes</span>
    </div>

    
    <div id="notes-container">
        <?php echo $__env->make('notes.partials.notes-grid', ['notes' => $notes], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterNotes() {
        ...
        fetch(`<?php echo e(route('notes.index')); ?>?${params}`, {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/notes/index.blade.php ENDPATH**/ ?>