...
<div class="lc-wrap">
    ...
    <div class="lc-card">
        ...
        <div class="lc-body">
            <?php if($errors->has('email') && $errors->first('email') === 'These credentials do not match our records.'): ?>
            <div class="lc-alert">
                ...
                <div class="lc-field">
                    ...
                    <div class="lc-input-wrap">
                        ...
                        <input type="email" id="email" name="email"
                               class="lc-input <?php $__errorArgs = ['email'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="lc-err"><i class="bi bi-exclamation-circle"></i><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="lc-field">
                    ...
                    <div class="lc-input-wrap">
                        ...
                        <input type="password" id="password" name="password"
                               class="lc-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH D:\projects\php8\task-manager\resources\views/auth/login.blade.php ENDPATH**/ ?>