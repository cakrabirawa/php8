<?php $__env->startSection('title', $file->name); ?>
...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            <a href="<?php echo e(route('files.index')); ?>" class="me-3 text-decoration-none">
                <i class="bi bi-arrow-left fs-5" style="color:rgba(255,255,255,.8);"></i>
            </a>
            <div>
                <h1 class="cu-header-title"><?php echo e(Str::limit($file->name, 55)); ?></h1>
                <p class="cu-header-sub">Uploaded <?php echo e($file->created_at->diffForHumans()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="cu-layout">
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                <div class="cu-avatar <?php echo e($file->type); ?>">
                    <i class="bi <?php echo e($icon); ?>"></i>
                </div>
                <div class="cu-panel-name"><?php echo e(Str::limit($file->name, 28)); ?></div>
                <span class="cu-type-badge <?php echo e($file->type); ?>"><?php echo e(ucfirst($file->type)); ?></span>
                ...
                <div class="cu-meta-row">
                    ...
                    <span>Uploaded <strong><?php echo e($file->created_at->format('M d, Y')); ?></strong></span>
                </div>
                <div class="cu-meta-row">
                    <i class="bi bi-clock-history"></i>
                    <span>Updated <?php echo e($file->updated_at->diffForHumans()); ?></span>
                </div>
                <div class="cu-meta-row">
                    <i class="bi bi-hdd"></i>
                    <span><strong><?php echo e($sizeStr); ?></strong></span>
                </div>
                <div class="cu-meta-row">
                    <i class="bi bi-filetype-<?php echo e($ext ?: 'txt'); ?>"></i>
                    <span>.<?php echo e(strtoupper($ext ?: '—')); ?></span>
                </div>

                <hr class="cu-divider">

                <a href="<?php echo e(Storage::url($file->path)); ?>" target="_blank" class="cu-action-btn dl">
                    <i class="bi bi-download"></i> Download
                </a>
                <a href="<?php echo e(route('files.edit', $file->id)); ?>" class="cu-action-btn edit">
        ...
        <div class="cu-sections">
            ...
            <div class="cu-section">
                ...
                <div class="cu-section-body">
                    <?php if($isImage): ?>
                        <img src="<?php echo e(Storage::url($file->path)); ?>"
                             alt="<?php echo e($file->name); ?>" class="cu-preview-img">
                    <?php elseif($isPdf): ?>
                        <iframe src="<?php echo e(Storage::url($file->path)); ?>"
                                class="cu-preview-pdf" title="<?php echo e($file->name); ?>"></iframe>
                    <?php else: ?>
                        <div class="cu-preview-generic">
                            <i class="bi <?php echo e($icon); ?>" style="color:<?php echo e($color); ?>;"></i>
                            <h4><?php echo e(Str::limit($file->name, 40)); ?></h4>
                            <p>Preview is not available for .<?php echo e(strtoupper($ext ?: 'this')); ?> files.<br>Click below to open or download.</p>
                            <a href="<?php echo e(Storage::url($file->path)); ?>" target="_blank" class="cu-open-btn">
            ...
            <div class="cu-section">
                ...
                <div class="cu-section-body">
                    <table class="cu-detail-table">
                        ...
                        <tr>
                            <td>Type</td>
                            <td><span class="cu-type-badge <?php echo e($file->type); ?>" style="display:inline-block;margin:0;"><?php echo e(ucfirst($file->type)); ?></span></td>
                        </tr>
                        <tr>
                            <td>Extension</td>
                            <td>.<?php echo e(strtoupper($ext ?: '—')); ?></td>
                        </tr>
                        <tr>
                            <td>Size</td>
                            <td><?php echo e($sizeStr); ?></td>
                        </tr>
                        <tr>
                            <td>Uploaded</td>
                            <td><?php echo e($file->created_at->format('M d, Y \a\t g:i A')); ?></td>
                        </tr>
                        <tr>
                            <td>Last Updated</td>
                            <td><?php echo e($file->updated_at->format('M d, Y \a\t g:i A')); ?></td>
                        </tr>
                        <tr>
                            <td>Owner</td>
                        ...
                        <tr>
                            <td>Path</td>
                            <td style="word-break:break-all;font-size:11px;color:#9ca3af;"><?php echo e($file->path); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/files/show.blade.php ENDPATH**/ ?>