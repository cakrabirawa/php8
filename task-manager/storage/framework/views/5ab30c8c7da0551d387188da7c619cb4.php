...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="cu-header-inner">
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="cu-btn-hdr">
    ...
    <div class="cu-alert-success"><i class="bi bi-check-circle-fill"></i> <?php echo e(session('success')); ?></div>
    <?php endif; ?>
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                <div class="cu-avatar-wrap">
                    <?php if($user->avatar): ?>
                        <img src="<?php echo e(Storage::url($user->avatar)); ?>" alt="<?php echo e($user->name); ?>" class="cu-avatar-img">
                    <?php else: ?>
                        <div class="cu-avatar-init"><?php echo e(strtoupper(substr($user->name,0,2))); ?></div>
                    <?php endif; ?>
                </div>
                <div class="cu-panel-name"><?php echo e($user->name); ?></div>
                <div class="cu-panel-email"><?php echo e($user->email); ?></div>

                <?php if($user->location): ?>
                <div class="cu-meta-row"><i class="bi bi-geo-alt"></i><span><?php echo e($user->location); ?></span></div>
                <?php endif; ?>
                <?php if($user->phone): ?>
                <div class="cu-meta-row"><i class="bi bi-telephone"></i><span><?php echo e($user->phone); ?></span></div>
                <?php endif; ?>
                <?php if($user->website): ?>
                <div class="cu-meta-row"><i class="bi bi-globe"></i><a href="<?php echo e($user->website); ?>" target="_blank" style="color:#6366f1;font-size:11px;word-break:break-all;"><?php echo e(Str::limit($user->website,30)); ?></a></div>
                <?php endif; ?>
                <div class="cu-meta-row"><i class="bi bi-calendar3"></i><span>Joined <strong><?php echo e($user->created_at->format('M Y')); ?></strong></span></div>

                <div class="cu-panel-nav">
                    <a href="<?php echo e(route('profile.show')); ?>" class="cu-nav-link active"><i class="bi bi-person"></i> Profile</a>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="cu-nav-link"><i class="bi bi-pencil"></i> Edit Info</a>
                    <a href="<?php echo e(route('profile.password')); ?>" class="cu-nav-link"><i class="bi bi-key"></i> Password</a>
                </div>
            </div>
        </div>
        ...
        <div class="cu-sections">
                ...
                <div class="cu-section-body">
                    <div class="cu-stat-row">
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->tasks()->count()); ?></div>
                            <div class="cu-stat-box-lbl">Tasks</div>
                        </div>
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->projects()->count()); ?></div>
                            <div class="cu-stat-box-lbl">Projects</div>
                        </div>
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->reminders()->count()); ?></div>
                            <div class="cu-stat-box-lbl">Reminders</div>
                        </div>
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->notes()->count()); ?></div>
                            <div class="cu-stat-box-lbl">Notes</div>
                        </div>
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->files()->count()); ?></div>
                            <div class="cu-stat-box-lbl">Files</div>
                        </div>
                        <div class="cu-stat-box">
                            <div class="cu-stat-box-num"><?php echo e($user->routines()->count()); ?></div>
            ...
            <div class="cu-section">
                <div class="cu-section-header">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" style="margin-left:auto;font-size:11px;color:#6366f1;font-weight:600;text-decoration:none;">Edit</a>
                </div>
                <div class="cu-section-body">
                    <table class="cu-detail-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($user->website): ?>
                                    <a href="<?php echo e($user->website); ?>" target="_blank" style="color:#6366f1;"><?php echo e(Str::limit($user->website,40)); ?></a>
                                <?php else: ?>
                                    —
                                <?php endif; ?>
                            </td>
            ...
            <div class="cu-section">
                ...
                <div class="cu-section-body">
                    <p style="font-size:13px;color:#374151;line-height:1.7;margin:0;"><?php echo e($user->bio); ?></p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="cu-section">
                ...
                <div class="cu-section-body" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;">
                    <div style="font-size:13px;color:#374151;">
                        ...
                        <span style="font-size:11px;color:#9ca3af;">Last updated <?php echo e($user->updated_at->diffForHumans()); ?></span>
                    </div>
                    <a href="<?php echo e(route('profile.password')); ?>" class="cu-btn-save" style="text-decoration:none;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/profile/show.blade.php ENDPATH**/ ?>