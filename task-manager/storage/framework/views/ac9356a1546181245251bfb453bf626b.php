    ...
    <div class="cu-layout">
        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                ...
                <div class="cu-panel-sub">Uploading on <?php echo e(now()->format('M d, Y')); ?></div>
        ...
        <form action="<?php echo e(route('files.store')); ?>" method="POST" enctype="multipart/form-data" id="upload-form">
            <?php echo csrf_field(); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="cu-err" style="margin-top:6px;"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="cu-section">
                    ...
                    <div class="cu-section-body">
                        <input type="hidden" name="type" id="type-hidden" value="<?php echo e(old('type', 'project')); ?>">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="cu-err" style="margin-top:8px;"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    </div>
                ...
                <div class="cu-action-bar">
                    <a href="<?php echo e(route('files.index')); ?>" class="cu-btn-cancel">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/files/create.blade.php ENDPATH**/ ?>