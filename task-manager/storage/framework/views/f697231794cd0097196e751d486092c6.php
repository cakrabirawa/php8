<?php $__env->startSection('title', 'Lina AI'); ?>
    ...
    <div class="lina-main">
        ...
        <div class="lina-head">
            ...
            <div class="lina-head-right">
                ...
                <a href="<?php echo e(url()->previous() == url()->current() ? route('dashboard') : url()->previous()); ?>" class="lina-icon-btn" title="Back" style="text-decoration:none;">
...
(function () {
    /* ── Config ── */
    const STREAM_URL    = "<?php echo e(route('ai.stream')); ?>";
    const CONV_URL      = "<?php echo e(url('/ai/conversations')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/ai/index.blade.php ENDPATH**/ ?>