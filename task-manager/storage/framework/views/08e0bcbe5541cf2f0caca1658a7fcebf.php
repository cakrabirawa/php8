...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="d-flex justify-content-between align-items-center" style="position:relative;z-index:1;">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="cu-new-btn">
    ...
    <div class="cu-stats">
        <div class="cu-stat">
            ...
            <div><div class="cu-stat-num"><?php echo e($totalProjects); ?></div><div class="cu-stat-label">Total</div></div>
        </div>
        <div class="cu-stat">
            <div class="cu-stat-icon active"><i class="bi bi-lightning-charge"></i></div>
            <div><div class="cu-stat-num"><?php echo e($activeProjects); ?></div><div class="cu-stat-label">Active</div></div>
        </div>
        <div class="cu-stat">
            <div class="cu-stat-icon done"><i class="bi bi-check-circle"></i></div>
            <div><div class="cu-stat-num"><?php echo e($doneProjects); ?></div><div class="cu-stat-label">Completed</div></div>
        </div>
        <div class="cu-stat">
            <div class="cu-stat-icon overdue"><i class="bi bi-exclamation-circle"></i></div>
            <div><div class="cu-stat-num"><?php echo e($overdueProjects); ?></div><div class="cu-stat-label">Overdue</div></div>
        </div>
    </div>
        ...
        <div class="cu-grid" id="cuGrid">
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="cu-card project-item"
                     data-name="<?php echo e(strtolower($project->name)); ?>"
                     data-status="<?php echo e($project->status); ?>"
                     data-progress="<?php echo e($progress); ?>"
                     data-created="<?php echo e($project->created_at->timestamp); ?>">
                    <div class="cu-color-bar" style="background:<?php echo e($projectColor); ?>;"></div>
                    <div class="cu-card-body">
                        <div class="cu-card-top">
                            <div class="cu-avatar" style="background:<?php echo e($projectColor); ?>;">
                                <?php echo e(strtoupper(substr($project->name, 0, 1))); ?>

                            </div>
                            <div class="flex-grow-1 min-w-0">
                                <div class="cu-card-name" title="<?php echo e($project->name); ?>"><?php echo e($project->name); ?></div>
                                <div class="cu-card-desc"><?php echo e(strip_tags($project->description) ?: 'No description'); ?></div>
                            </div>
                        </div>

                        <div class="d-flex align-items-center justify-content-between mb-1">
                            <span class="cu-chip <?php echo e($chipClass); ?>">
                                <i class="bi bi-circle-fill" style="font-size:6px;"></i><?php echo e($chipLabel); ?>

                            </span>
                            <span style="font-size:11px; color:#8a8f98;"><?php echo e(round($progress)); ?>%</span>
                        </div>

                        <div class="cu-progress-wrap">
                            <div class="cu-progress-bar-bg">
                                <div class="cu-progress-bar-fill" style="background:<?php echo e($projectColor); ?>; width:<?php echo e($progress); ?>%;"></div>
                            </div>
                        </div>

                        <div class="cu-card-meta">
                            <?php if($project->end_date): ?>
                                <span class="<?php echo e($isOverdue ? 'overdue' : ''); ?>">
                                    <i class="bi bi-calendar3"></i>
                                    <?php if($isOverdue): ?> Overdue
                                    <?php else: ?> <?php echo e($project->end_date->format('M d')); ?>

                                    <?php endif; ?>
                                </span>
                            <?php endif; ?>
                            <?php if($totalTasks > 0): ?>
                                <span><i class="bi bi-check2-square"></i><?php echo e($completedTasks); ?>/<?php echo e($totalTasks); ?></span>
                            <?php endif; ?>
                            <?php if($teamCount > 0): ?>
                                <span class="d-flex align-items-center gap-1">
                                    <div class="cu-team-avatars">
                                        <?php $__currentLoopData = $project->teamMembers->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="cu-team-avatar" title="<?php echo e($member->name); ?>"><?php echo e(strtoupper(substr($member->name,0,1))); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($teamCount > 3): ?><div class="cu-team-avatar">+<?php echo e($teamCount - 3); ?></div><?php endif; ?>
                                    </div>
                                    <?php echo e($teamCount); ?>
                        ...
                        <div class="cu-card-actions">
                            <a href="<?php echo e(route('projects.tasks.index', $project)); ?>" class="cu-action-btn" title="Tasks"><i class="bi bi-list-task"></i></a>
                            <a href="<?php echo e(route('projects.show', $project)); ?>" class="cu-action-btn" title="View"><i class="bi bi-eye"></i></a>
                            <a href="<?php echo e(route('projects.edit', $project)); ?>" class="cu-action-btn" title="Edit"><i class="bi bi-pencil"></i></a>
                            <form action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="d-inline"
            ...
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="cu-list-row project-item"
                    ...
                    <div class="cu-list-name">
                        <div class="cu-list-avatar" style="background:<?php echo e($projectColor); ?>;"><?php echo e(strtoupper(substr($project->name,0,1))); ?></div>
                        <span title="<?php echo e($project->name); ?>"><?php echo e($project->name); ?></span>
                    </div>
                    <div class="cu-list-meta col-meta">
                        <?php if($project->end_date): ?>
                            <span class="<?php echo e($isOverdue ? 'text-danger fw-semibold' : ''); ?>" style="font-size:11px;">
                                <?php if($isOverdue): ?><i class="bi bi-exclamation-circle me-1"></i>Overdue
                                <?php else: ?> <?php echo e($project->end_date->format('M d, Y')); ?>

                                <?php endif; ?>
                            </span>
                        <?php else: ?> <span style="color:#d3d5db;">—</span>
                        <?php endif; ?>
                    </div>
                    <div class="cu-list-progress col-prog">
                        <div class="cu-list-pb">
                            <div class="cu-list-pb-fill" style="background:<?php echo e($projectColor); ?>; width:<?php echo e($progress); ?>%;"></div>
                        </div>
                        <span><?php echo e(round($progress)); ?>%</span>
                    </div>
                    <div><span class="cu-chip <?php echo e($chipClass); ?>"><i class="bi bi-circle-fill" style="font-size:6px;"></i><?php echo e($chipLabel); ?></span></div>
    ...
    <?php else: ?>
        <div class="cu-empty">
            ...
            <a href="<?php echo e(route('projects.create')); ?>" class="cu-empty-btn"><i class="bi bi-plus-lg"></i>Create Project</a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/projects/index.blade.php ENDPATH**/ ?>