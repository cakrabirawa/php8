...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="cu-header-inner">
            ...
            <a href="<?php echo e(route('files.create')); ?>" class="cu-btn-new">
    ...
    <div class="cu-stats">
        <div class="cu-stat total" onclick="filterType('')">
            ...
            <div class="cu-stat-num"><?php echo e($files->count()); ?></div>
        ...
        <div class="cu-stat project" onclick="filterType('project')">
            ...
            <div class="cu-stat-num"><?php echo e($files->where('type','project')->count()); ?></div>
        ...
        <div class="cu-stat docs" onclick="filterType('docs')">
            ...
            <div class="cu-stat-num"><?php echo e($files->where('type','docs')->count()); ?></div>
        ...
        <div class="cu-stat code" onclick="filterType('code')">
            ...
            <div class="cu-stat-num"><?php echo e($files->whereIn('type',['code','txt'])->count()); ?></div>
        ...
        <div class="cu-stat image" onclick="filterType('image')">
            ...
            <div class="cu-stat-num"><?php echo e($files->where('type','image')->count()); ?></div>
    ...
    <div class="cu-filter-bar">
        ...
        <span class="cu-count" id="file-count"><?php echo e($files->count()); ?> file(s)</span>
    </div>
    ...
    <div class="cu-file-grid" id="file-grid">
        ...
        <div class="cu-file-card"
             data-name="<?php echo e(strtolower($file->name)); ?>"
             data-type="<?php echo e($file->type); ?>">
            <div class="cu-file-card-accent <?php echo e($file->type); ?>"></div>
            <div class="cu-file-body">
                <div class="cu-file-top">
                    <div class="cu-file-icon <?php echo e($file->type); ?>">
                        <i class="bi <?php echo e($icon); ?>"></i>
                    </div>
                    <div class="cu-file-meta">
                        <div class="cu-file-name" title="<?php echo e($file->name); ?>"><?php echo e(Str::limit($file->name, 32)); ?></div>
                        <span class="cu-file-badge <?php echo e($file->type); ?>"><?php echo e(ucfirst($file->type)); ?></span>
                    </div>
                </div>
                ...
                <div class="cu-file-actions">
                    <a href="<?php echo e(route('files.show', $file->id)); ?>" class="cu-file-btn view" title="View Details">
                        <i class="bi bi-eye"></i> View
                    </a>
                    <a href="<?php echo e(Storage::url($file->path)); ?>" target="_blank" class="cu-file-btn download" title="Download / View">
                        <i class="bi bi-download"></i>
                    </a>
                    <a href="<?php echo e(route('files.edit', $file->id)); ?>" class="cu-file-btn edit" title="Edit">
    ...
    <div class="cu-empty">
        ...
        <a href="<?php echo e(route('files.create')); ?>" class="cu-btn-upload">
            <i class="bi bi-cloud-upload"></i> Upload File
        </a>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/files/index.blade.php ENDPATH**/ ?>