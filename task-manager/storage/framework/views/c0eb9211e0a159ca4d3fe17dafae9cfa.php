<?php $__env->startSection('title', 'Routines'); ?>
...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center justify-content-between" style="position:relative;z-index:1;">
            ...
            <a href="<?php echo e(route('routines.create')); ?>" class="cu-btn-new">
    ...
    <div class="cu-stats">
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($daily); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($weekly); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($monthly); ?></div>
        ...
        <div class="cu-stat">
            ...
            <div>
                <div class="cu-stat-val"><?php echo e($total); ?></div>
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    Daily Routines
                    <span class="cu-col-count"><?php echo e($daily); ?></span>
                </div>
                <a href="<?php echo e(route('routines.create')); ?>" class="cu-col-add" title="Add routine">
            ...
            <div class="cu-col-body">
                ...
                <div class="cu-routine-card">
                    <div class="cu-routine-title"><?php echo e($routine->title); ?></div>
                    <?php if($routine->description): ?>
                    <div class="cu-routine-desc"><?php echo e(Str::limit(strip_tags($routine->description), 90)); ?></div>
                    <?php endif; ?>
                    <div class="cu-routine-meta">
                        <?php if($routine->days): ?>
                        <span class="cu-meta-pill">
                            <i class="bi bi-calendar-day"></i>
                            <?php echo e(implode(', ', array_map('ucfirst', json_decode($routine->days, true) ?? []))); ?>

                        </span>
                        <?php endif; ?>
                        <?php if($routine->start_time && $routine->end_time): ?>
                        <span class="cu-meta-pill">
                            <i class="bi bi-clock"></i>
                            <?php echo e(\Carbon\Carbon::parse($routine->start_time)->format('g:i A')); ?>

                            &ndash;
                            <?php echo e(\Carbon\Carbon::parse($routine->end_time)->format('g:i A')); ?>

                        </span>
                        <?php endif; ?>
                    </div>
                    <div class="cu-routine-footer">
                        <a href="<?php echo e(route('routines.edit', $routine->id)); ?>" class="cu-card-btn edit">
                            <i class="bi bi-pencil"></i> Edit
                        </a>
                        <form action="<?php echo e(route('routines.destroy', $routine->id)); ?>" method="POST" style="display:inline;"
            ...
            <div class="cu-col-footer">
                <a href="<?php echo e(route('routines.showDaily')); ?>" class="cu-view-all">
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    Weekly Routines
                    <span class="cu-col-count"><?php echo e($weekly); ?></span>
                </div>
                <a href="<?php echo e(route('routines.create')); ?>" class="cu-col-add" title="Add routine">
                    <i class="bi bi-plus"></i>
                </a>
            ...
            <div class="cu-col-body">
                ...
                <div class="cu-routine-card">
                    ...
                    <?php endif; ?>
                    <div class="cu-routine-meta">
                        <?php if($routine->weeks): ?>
                        <span class="cu-meta-pill">
                            <i class="bi bi-calendar-week"></i>
                            Week <?php echo e(implode(', ', json_decode($routine->weeks, true) ?? [])); ?>
            ...
            <div class="cu-col-footer">
                <a href="<?php echo e(route('routines.showWeekly')); ?>" class="cu-view-all">
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    Monthly Routines
                    <span class="cu-col-count"><?php echo e($monthly); ?></span>
                </div>
                <a href="<?php echo e(route('routines.create')); ?>" class="cu-col-add" title="Add routine">
                    <i class="bi bi-plus"></i>
                </a>
            ...
            <div class="cu-col-footer">
                <a href="<?php echo e(route('routines.showMonthly')); ?>" class="cu-view-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/routines/index.blade.php ENDPATH**/ ?>