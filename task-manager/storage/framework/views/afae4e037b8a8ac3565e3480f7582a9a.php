...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            <a href="<?php echo e(route('profile.show')); ?>" class="me-3 text-decoration-none">
    ...
    <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" id="profile-form">
        <?php echo csrf_field(); ?>
            ...
            <div class="cu-info-panel">
                ...
                <div class="cu-info-body">
                    <div class="cu-avatar-wrap">
                        <?php if($user->avatar): ?>
                            <img src="<?php echo e(Storage::url($user->avatar)); ?>" alt="<?php echo e($user->name); ?>" class="cu-avatar-img" id="avatar-preview-img">
                        <?php else: ?>
                            <div class="cu-avatar-init" id="avatar-init"><?php echo e(strtoupper(substr($user->name,0,2))); ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="cu-panel-nav" style="margin-top:12px;">
                        <a href="<?php echo e(route('profile.show')); ?>" class="cu-nav-link"><i class="bi bi-person"></i> View Profile</a>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="cu-nav-link active"><i class="bi bi-pencil"></i> Edit Info</a>
                        ...
                        <div class="cu-field-row">
                            <div class="cu-field">
                                ...
                                <input type="text" id="name" name="name"
                                       class="cu-input <?php $__errorArgs = ['name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="cu-err"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            </div>
                            <div class="cu-field">
                                ...
                                <input type="email" id="email" name="email"
                                       class="cu-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="cu-field-row">
                            <div class="cu-field">
                                ...
                                <input type="tel" id="phone" name="phone"
                                       class="cu-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="+1 555 000 0000">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="cu-field">
                                ...
                                <input type="text" id="location" name="location"
                                       class="cu-input <?php $__errorArgs = ['location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('location', $user->location)); ?>" placeholder="City, Country">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <input type="url" id="website" name="website"
                                   class="cu-input <?php $__errorArgs = ['website'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <textarea id="bio" name="bio" rows="4"
                                      class="cu-textarea <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Tell us about yourself…" maxlength="500"><?php echo e(old('bio', $user->bio)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="cu-action-bar">
                    <a href="<?php echo e(route('profile.show')); ?>" class="cu-btn-cancel"><i class="bi bi-x-lg"></i> Cancel</a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (delBtn) {
        delBtn.addEventListener('click', function () {
            ...
            fetch('<?php echo e(route("profile.avatar.delete")); ?>', {
                method: 'DELETE',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/profile/edit.blade.php ENDPATH**/ ?>