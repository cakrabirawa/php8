...
<div class="main-content">
    ...
    <div class="cu-layout">
        ...
        <form action="<?php echo e(route('projects.store')); ?>" method="POST" id="createProjectForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-editor-wrap">
                                ...
                                <textarea name="description" id="description" style="display:none;"><?php echo e(old('description')); ?></textarea>
                            </div>
                        ...
                        <div class="cu-status-chips">
                            <div class="cu-chip-option chip-not-started">
                                <input type="radio" name="status" id="status_not_started" value="not_started"
                                    <?php echo e(old('status', 'not_started') == 'not_started' ? 'checked' : ''); ?>>
                            ...
                            <div class="cu-chip-option chip-in-progress">
                                <input type="radio" name="status" id="status_in_progress" value="in_progress"
                                    <?php echo e(old('status') == 'in_progress' ? 'checked' : ''); ?>>
                            ...
                            <div class="cu-chip-option chip-completed">
                                <input type="radio" name="status" id="status_completed" value="completed"
                                    <?php echo e(old('status') == 'completed' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cu-action-bar">
                        <a href="<?php echo e(route('projects.index')); ?>" class="cu-btn-cancel">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/projects/create.blade.php ENDPATH**/ ?>