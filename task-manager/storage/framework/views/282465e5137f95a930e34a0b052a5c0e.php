<?php $__env->startSection('title', $project->name . ' — Project Details'); ?>
...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="d-flex align-items-center" style="position:relative;z-index:1;">
            <a href="<?php echo e(route('projects.index')); ?>" class="me-3 text-decoration-none">
                <i class="bi bi-arrow-left fs-5" style="color:rgba(255,255,255,.8);"></i>
            </a>
            <div>
                <h1 class="content-title mb-0"><?php echo e($project->name); ?></h1>
    ...
    <div class="cu-layout">
        ...
        <div class="cu-left-panel">
            <div class="cu-panel-top">
                <div class="cu-panel-avatar" style="background:<?php echo e($projectColor); ?>;">
                    <?php echo e(strtoupper(substr($project->name,0,1))); ?>

                </div>
                <div class="cu-panel-name"><?php echo e($project->name); ?></div>
                <span class="cu-panel-chip <?php echo e($chip['class']); ?>">
            ...
            <div class="cu-panel-rows">
                ...
                <div class="cu-panel-row">
                    ...
                    <span class="cu-panel-row-value" style="<?php echo e($project->end_date && $project->end_date->isPast() ? 'color:#dc2626;' : ''); ?>">
                        <?php echo e($project->end_date ? $project->end_date->format('M d, Y') : '—'); ?>

                        <?php if($project->end_date && $project->end_date->isPast()): ?>
                            <small class="d-block" style="font-size:10px;">Overdue</small>
                        <?php elseif($project->end_date): ?>
                            <small class="d-block" style="font-size:10px;color:#8a8f98;"><?php echo e($project->end_date->diffForHumans()); ?></small>
                        <?php endif; ?>
                    </span>
                </div>
                <div class="cu-panel-row">
                    <span class="cu-panel-row-label"><i class="bi bi-currency-dollar"></i> Budget</span>
                    <span class="cu-panel-row-value">$<?php echo e(number_format($project->budget ?? 0, 0)); ?></span>
                </div>
                <div class="cu-panel-row">
                    <span class="cu-panel-row-label"><i class="bi bi-list-task"></i> Tasks</span>
                    <span class="cu-panel-row-value"><?php echo e($totalTasks); ?></span>
                </div>
                <div class="cu-panel-row">
                    <span class="cu-panel-row-label"><i class="bi bi-people"></i> Team</span>
                    <span class="cu-panel-row-value"><?php echo e($teamMembers->count()); ?> members</span>
                </div>
                <div class="cu-panel-row">
                    <span class="cu-panel-row-label"><i class="bi bi-clock-history"></i> Updated</span>
                    <span class="cu-panel-row-value"><?php echo e($project->updated_at->diffForHumans()); ?></span>
                </div>
            </div>

            <div class="cu-panel-actions">
                <a href="<?php echo e(route('projects.tasks.index', $project)); ?>" class="cu-panel-action-btn primary">
                    <i class="bi bi-list-task"></i> View Tasks
                </a>
                <a href="<?php echo e(route('projects.edit', $project)); ?>" class="cu-panel-action-btn">
                ...
                <form id="deleteForm" action="<?php echo e(route('projects.destroy', $project)); ?>" method="POST" class="d-none">
                ...
                <div class="cu-section-body">
                        ...
                        <div class="cu-ring-wrap">
                            <svg>
                                ...
                                <circle class="fg" id="progressRing"
                                        style="stroke:<?php echo e($projectColor); ?>; stroke-dashoffset:<?php echo e($ringOffset); ?>;"></circle>
                            </svg>
                            <div class="cu-ring-pct"><?php echo e(round($progress)); ?>%</div>
                        </div>
                        <div class="cu-stat-tiles">
                            <div class="cu-stat-tile">
                                <div class="cu-stat-num" style="color:#16a34a;"><?php echo e($completedTasks); ?></div>
                                <div class="cu-stat-label">Done</div>
                            </div>
                            <div class="cu-stat-tile">
                                <div class="cu-stat-num" style="color:#7c3aed;"><?php echo e($inProgressTasks); ?></div>
                                <div class="cu-stat-label">Active</div>
                            </div>
                            <div class="cu-stat-tile">
                                <div class="cu-stat-num" style="color:#8a8f98;"><?php echo e($todoTasks); ?></div>
                    ...
                    <?php if($totalTasks > 0): ?>
                        <div class="cu-progress-bar-wrap">
                            <div class="cu-progress-bar-fill" id="progressBar"
                                 style="background:<?php echo e($projectColor); ?>; width:0%;"></div>
                        </div>
                        <div class="d-flex justify-content-between mt-1" style="font-size:11px;color:#8a8f98;">
                            <span><?php echo e($completedTasks); ?> of <?php echo e($totalTasks); ?> tasks completed</span>
                    ...
                    <?php else: ?>
                        <p class="mt-3 mb-0" style="font-size:13px;color:#8a8f98;">
                            ...
                            <a href="<?php echo e(route('projects.tasks.index', $project)); ?>" style="color:#7c3aed;">Add your first task →</a>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="cu-section-body">
                    ...
                    <?php else: ?>
                        <p class="mb-0" style="color:#8a8f98;font-size:13px;font-style:italic;">
                            ...
                            <a href="<?php echo e(route('projects.edit', $project)); ?>" style="color:#7c3aed;">Add one →</a>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="cu-section">
                <div class="cu-section-header" style="justify-content:space-between;">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="cu-section-title">Team Members (<?php echo e($teamMembers->count()); ?>)</span>
                    </div>
                ...
                <div class="cu-section-body" style="padding-top:8px;padding-bottom:8px;">
                    <?php $__empty_1 = true; $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="cu-member">
                            <div class="cu-member-av" style="background:<?php echo e($colors[strlen($member->name) % count($colors)]); ?>;">
                                <?php echo e(strtoupper(substr($member->name,0,1))); ?>

                            </div>
                            <div>
                                <div class="cu-member-name"><?php echo e($member->name); ?></div>
                                <div class="cu-member-email"><?php echo e($member->email); ?></div>
                            </div>
                        </div>
...
function confirmDelete() {
    if (confirm('Delete "<?php echo e(addslashes($project->name)); ?>"? All tasks, files and data will be permanently removed. This cannot be undone.')) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/projects/show.blade.php ENDPATH**/ ?>