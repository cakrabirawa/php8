<?php $__env->startSection('title', isset($project) ? $project->name . ' — Tasks' : 'My Tasks'); ?>
...
<div class="main-content">
    ...
    <div class="cu-header">
        <div class="d-flex align-items-center gap-2" style="position:relative;z-index:1;">
            <?php if(isset($project)): ?>
                <a href="<?php echo e(route('projects.show', $project)); ?>" class="text-decoration-none" style="color:rgba(255,255,255,.7);">
                    <i class="bi bi-arrow-left" style="font-size:16px;"></i>
                </a>
            <?php endif; ?>
            <div>
                <div class="cu-header-title"><?php echo e(isset($project) ? $project->name . ' — Tasks' : 'My Tasks'); ?></div>
                <div class="cu-header-sub"><?php echo e(isset($project) ? 'Manage and track tasks for this project' : 'All active tasks across your projects'); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="cu-toolbar">
        ...
        <div class="cu-toolbar-right">
            <span style="font-size:12px;color:#8a8f98;"><?php echo e($totalCnt); ?> task<?php echo e($totalCnt != 1 ? 's' : ''); ?></span>
    ...
    <?php if(!$hasAny): ?>
        <div class="cu-empty">
            ...
            <h5>No tasks yet</h5>
            <p><?php echo e(isset($project) ? 'Create the first task for ' . $project->name . '.' : 'No tasks found. Create one to get started.'); ?></p>
            <button class="cu-btn-new" data-bs-toggle="modal" data-bs-target="#createTaskModal">
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    To Do
                    <span class="cu-col-count" id="cnt-to_do"><?php echo e($todoCnt); ?></span>
                </div>
            ...
            <div class="cu-col-body" id="col-to_do" data-status="to_do">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['to_do'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('tasks._card', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    In Progress
                    <span class="cu-col-count" id="cnt-in_progress"><?php echo e($progressCnt); ?></span>
                </div>
            ...
            <div class="cu-col-body" id="col-in_progress" data-status="in_progress">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['in_progress'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('tasks._card', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    On Hold
                    <span class="cu-col-count" id="cnt-on_hold"><?php echo e($onHoldCnt); ?></span>
                </div>
            ...
            <div class="cu-col-body" id="col-on_hold" data-status="on_hold">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['on_hold'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('tasks._card', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    In Review
                    <span class="cu-col-count" id="cnt-in_review"><?php echo e($inReviewCnt); ?></span>
                </div>
            ...
            <div class="cu-col-body" id="col-in_review" data-status="in_review">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['in_review'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('tasks._card', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="cu-col">
            <div class="cu-col-head">
                <div class="cu-col-head-left">
                    ...
                    Completed
                    <span class="cu-col-count" id="cnt-completed"><?php echo e($completedCnt); ?></span>
                </div>
            ...
            <div class="cu-col-body" id="col-completed" data-status="completed">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['completed'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('tasks._card', ['task' => $task], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="cu-list-view" id="cuList">
        ...
        <?php $__currentLoopData = collect($tasks)->flatten(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="cu-list-row" data-title="<?php echo e(strtolower($task->title)); ?>" data-priority="<?php echo e($task->priority); ?>" data-project="<?php echo e($task->project_id); ?>">
            <div>
                <div class="cu-list-title"><?php echo e($task->title); ?></div>
                <div class="cu-list-sub">
                    <span class="cu-status-chip <?php echo e($task->status); ?>">
            ...
            <div><span class="cu-priority <?php echo e($task->priority); ?>"><?php echo e(ucfirst($task->priority)); ?></span></div>
            <div style="font-size:12px;color:#3d4149;">
                <?php if($task->user): ?>
                    <div style="display:flex;align-items:center;gap:6px;">
                        <div class="cu-assignee" style="width:24px;height:24px;font-size:10px;"><?php echo e(strtoupper(substr($task->user->name,0,1))); ?></div>
            ...
            <div class="cu-due <?php echo e($task->due_date && \Carbon\Carbon::parse($task->due_date)->isPast() && $task->status !== 'completed' ? 'overdue' : ''); ?>" style="font-size:12px;">
            ...
            <div class="cu-list-actions">
                <a href="<?php echo e(route('tasks.show', $task->id)); ?>" class="cu-task-btn" title="View"><i class="bi bi-eye"></i></a>
                <a href="<?php echo e(route('tasks.edit', $task->id)); ?>" class="cu-task-btn" title="Edit"><i class="bi bi-pencil"></i></a>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<div class="modal fade cu-modal" id="createTaskModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(isset($project) ? route('projects.tasks.store', $project) : route('tasks.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-3">
                            <div class="cu-field">
                                ...
                                <select name="project_id" class="cu-input cu-select" required>
                                    ...
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($proj->id); ?>" <?php echo e(isset($project) && $project->id == $proj->id ? 'selected' : ''); ?>><?php echo e($proj->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="cu-field">
                                ...
                                <select name="user_id" class="cu-input cu-select" required>
                                    <option value="<?php echo e(auth()->id()); ?>" selected>Me</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/tasks/index.blade.php ENDPATH**/ ?>