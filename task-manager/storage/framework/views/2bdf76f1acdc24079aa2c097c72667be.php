        ...
        <div class="cu-info-panel">
            ...
            <div class="cu-info-body">
                <?php if(auth()->user()->avatar): ?>
                    <img src="<?php echo e(Storage::url(auth()->user()->avatar)); ?>" alt="" class="cu-avatar-img-sm">
                <?php else: ?>
                    <div class="cu-avatar-init"><?php echo e(strtoupper(substr(auth()->user()->name,0,2))); ?></div>
                <?php endif; ?>
                <div class="cu-panel-name"><?php echo e(auth()->user()->name); ?></div>
                <div class="cu-panel-email"><?php echo e(auth()->user()->email); ?></div>
                ...
                <div class="cu-panel-nav" style="margin-top:12px;">
                    ...
                    <a href="<?php echo e(route('profile.password')); ?>" class="cu-nav-link active"><i class="bi bi-key"></i> Password</a>
                </div>
            </div>
        </div>

        
        <form action="<?php echo e(route('profile.password.update')); ?>" method="POST" id="pw-form">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-pw-wrap">
                                <input type="password" id="current_password" name="current_password"
                                       class="cu-input <?php $__errorArgs = ['current_password'];
                        ...
                        <div class="cu-field">
                            ...
                            <div class="cu-pw-wrap">
                                <input type="password" id="password" name="password"
                                       class="cu-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\php8\task-manager\resources\views/profile/password.blade.php ENDPATH**/ ?>