...
>
    <div class="flex w-full items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <?php echo $__env->make('backend.layouts.partials.header.quick-links-dropdown', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <?php echo $__env->make('backend.layouts.partials.header.quick-add-dropdown', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ai_content.generate')): ?>
                <?php echo $__env->make('backend.layouts.partials.header.ai-command-button', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
        </div>

        <div class="flex gap-2 justify-center items-center">
            <?php echo Hook::applyFilters(AdminFilterHook::ADMIN_HEAD_MIDDLE, ''); ?>

        </div>

        <div class="flex gap-2 lg:justify-end items-center">
            <?php echo $__env->make('backend.layouts.partials.header.right-menu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</header>
<?php /**PATH D:\projects\php8\lara\resources\views/backend/layouts/partials/header/index.blade.php ENDPATH**/ ?>