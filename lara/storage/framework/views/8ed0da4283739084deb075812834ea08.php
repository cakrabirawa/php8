    ...
    <div class="px-4 py-3 sm:px-6">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="hidden sm:inline">Laravel <?php echo e(Illuminate\Foundation\Application::VERSION); ?></span>
                <span class="sm:hidden">L<?php echo e(Illuminate\Foundation\Application::VERSION); ?></span>
            </div>

            
            <div class="flex items-center gap-2">
                <span class="hidden sm:inline"><?php echo e(__('Made with')); ?></span>
...
<?php /**PATH D:\projects\php8\lara\resources\views/backend/layouts/partials/footer.blade.php ENDPATH**/ ?>