...
<button
    ...
    onclick="openMediaModal('<?php echo e($id); ?>', <?php echo e($multiple ? 'true' : 'false'); ?>, '<?php echo e($allowedTypes); ?>', <?php echo e($onSelect ? "'{$onSelect}'" : 'null'); ?>)"
>
...
<!-- Media Modal -->
<div id="<?php echo e($id); ?>" class="fixed inset-0 z-50 hidden bg-black/20 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4">
    <div class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-lg shadow-2xl border border-white/20 dark:border-gray-700/50 max-w-7xl w-full h-[95vh] sm:h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between p-4 lg:p-6 border-b border-gray-200 dark:border-gray-700 shrink-0">
            <h3 class="text-base lg:text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($title); ?></h3>
            <button
                type="button"
                onclick="closeMediaModal('<?php echo e($id); ?>')"
        ...
        <div class="flex-1 flex flex-col lg:flex-row overflow-hidden">
            ...
            <div class="w-full lg:w-64 bg-gray-50 dark:bg-gray-900 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-gray-700 p-4 shrink-0">
                ...
                <div class="flex flex-col sm:flex-row lg:flex-col gap-3 lg:gap-0">
                    ...
                    <div class="lg:mb-6 sm:w-auto lg:w-full">
                        <button
                            type="button"
                            onclick="triggerFileUpload('<?php echo e($id); ?>')"
                            class="w-full btn-primary flex items-center justify-center gap-2"
                        >
                            <iconify-icon icon="lucide:upload"></iconify-icon>
                            <span class="hidden sm:inline lg:inline"><?php echo e(__('Upload Files')); ?></span>
                            <span class="sm:hidden lg:hidden"><?php echo e(__('Upload')); ?></span>
                        </button>
                        <input
                            type="file"
                            id="<?php echo e($id); ?>_fileInput"
                            class="hidden"
                            <?php echo e($multiple ? 'multiple' : ''); ?>

                            accept="<?php echo e($allowedTypes === 'images' ? 'image/*' : ($allowedTypes === 'videos' ? 'video/*' : ($allowedTypes === 'audio' ? 'audio/*' : ($allowedTypes === 'documents' ? '.pdf,.doc,.docx,.txt' : '*')))); ?>"
                            onchange="handleFileUpload(event, '<?php echo e($id); ?>')"
                        >
                    </div>
                    ...
                    <div class="flex flex-row sm:flex-row lg:flex-col gap-3 lg:gap-4 flex-1 lg:flex-initial">
                        <div class="flex-1 lg:flex-initial">
                            <label class="hidden lg:block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('Filter by Type')); ?></label>
                            <select
                                id="<?php echo e($id); ?>_typeFilter"
                                class="form-control w-full"
                                onchange="filterMediaByType('<?php echo e($id); ?>', this.value)"
                            >
                                <option value="all"><?php echo e(__('All Files')); ?></option>
                                <option value="images"><?php echo e(__('Images')); ?></option>
                                <option value="videos"><?php echo e(__('Videos')); ?></option>
                                <option value="audio"><?php echo e(__('Audio')); ?></option>
                                <option value="documents"><?php echo e(__('Documents')); ?></option>
                            </select>
                        </div>

                        <div class="flex-1 lg:flex-initial">
                            <label class="hidden lg:block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"><?php echo e(__('Search')); ?></label>
                            <input
                                type="text"
                                id="<?php echo e($id); ?>_searchInput"
                                class="form-control w-full"
                                placeholder="<?php echo e(__('Search files...')); ?>"
                                oninput="searchMedia('<?php echo e($id); ?>', this.value)"
                            >
                        </div>
                    </div>

                    <!-- Selected Files Count -->
                    <div id="<?php echo e($id); ?>_selectedInfo" class="lg:mt-6 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg hidden">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            <span id="<?php echo e($id); ?>_selectedCount">0</span> <?php echo e(__('file(s) selected')); ?>
            ...
            <div class="flex-1 flex flex-col min-h-0 lg:min-h-full">
                <!-- Loading State -->
                <div id="<?php echo e($id); ?>_loading" class="flex-1 flex items-center justify-center">
                    <div class="text-center">
                        <iconify-icon icon="lucide:loader-2" class="text-4xl text-gray-400 animate-spin mb-4"></iconify-icon>
                        <p class="text-gray-500 dark:text-gray-400"><?php echo e(__('Loading media files...')); ?></p>
                    </div>
                </div>

                <!-- Media Grid -->
                <div id="<?php echo e($id); ?>_mediaGrid" class="flex-1 p-4 lg:p-6 overflow-y-auto hidden">
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4" id="<?php echo e($id); ?>_mediaContainer">
                        <!-- Media items will be loaded here -->
                    </div>

                    <!-- Load More Button -->
                    <div id="<?php echo e($id); ?>_loadMoreSection" class="flex justify-center mt-6 hidden">
                        <button
                            type="button"
                            id="<?php echo e($id); ?>_loadMoreButton"
                            onclick="loadMoreMedia('<?php echo e($id); ?>')"
                            class="btn-default px-6 py-2 flex items-center gap-2"
                        >
                            <iconify-icon icon="lucide:chevron-down" class="text-lg"></iconify-icon>
                            <?php echo e(__('Load More')); ?> (100 <?php echo e(__('items')); ?>)
                        </button>
                    </div>
                </div>

                <!-- Empty State -->
                <div id="<?php echo e($id); ?>_emptyState" class="flex-1 flex items-center justify-center hidden">
                    <div class="text-center">
                        <iconify-icon icon="lucide:image" class="text-6xl text-gray-300 dark:text-gray-600 mb-4"></iconify-icon>
                        <p class="text-gray-500 dark:text-gray-400 mb-4"><?php echo e(__('No media files found')); ?></p>
                        <button
                            type="button"
                            onclick="triggerFileUpload('<?php echo e($id); ?>')"
                            class="btn-primary"
                        >
                            <?php echo e(__('Upload Your First File')); ?>
            ...
            <div class="hidden lg:flex w-64 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 flex-col shrink-0">
                <!-- No Selection State -->
                <div id="<?php echo e($id); ?>_noSelection" class="flex-1 flex items-center justify-center p-6">
                    <div class="text-center">
                        <iconify-icon icon="lucide:mouse-pointer-click" class="text-4xl text-gray-300 dark:text-gray-600 mb-3"></iconify-icon>
                        <p class="text-gray-500 dark:text-gray-400 text-sm"><?php echo e(__('Select a file to view details')); ?></p>
                    </div>
                </div>

                <!-- Media Details -->
                <div id="<?php echo e($id); ?>_mediaDetails" class="hidden flex-1 flex flex-col">
                    <!-- Preview Area -->
                    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                        <div id="<?php echo e($id); ?>_previewContainer" class="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden relative group">
                    ...
                    <div class="flex-1 p-4 overflow-y-auto">
                        <div class="space-y-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('File Name')); ?></label>
                                <p id="<?php echo e($id); ?>_fileName" class="text-sm text-gray-900 dark:text-white break-all"></p>
                            </div>

                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('File Type')); ?></label>
                                <p id="<?php echo e($id); ?>_fileType" class="text-sm text-gray-900 dark:text-white"></p>
                            </div>

                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('File Size')); ?></label>
                                <p id="<?php echo e($id); ?>_fileSize" class="text-sm text-gray-900 dark:text-white"></p>
                            </div>

                            <div id="<?php echo e($id); ?>_imageDimensions" class="hidden">
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Dimensions')); ?></label>
                                <p id="<?php echo e($id); ?>_dimensions" class="text-sm text-gray-900 dark:text-white"></p>
                            </div>

                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Uploaded')); ?></label>
                                <p id="<?php echo e($id); ?>_uploadDate" class="text-sm text-gray-900 dark:text-white"></p>
                            </div>

                            <div>
                                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('URL')); ?></label>
                                <div class="flex items-center gap-2">
                                    <input id="<?php echo e($id); ?>_fileUrl" type="text" readonly class="form-control text-xs flex-1 min-w-0" title="" />
                                    <button type="button" onclick="copyToClipboard('<?php echo e($id); ?>_fileUrl')" class="btn-default p-2" title="<?php echo e(__('Copy URL')); ?>">
                            ...
                            <div class="flex gap-2 pt-2">
                                <button type="button"
                                        id="<?php echo e($id); ?>_downloadButton"
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between p-4 lg:p-6 border-t border-gray-200 dark:border-gray-700 gap-3 shrink-0">
            <div class="text-sm text-gray-500 dark:text-gray-400 order-2 sm:order-1">
                <span id="<?php echo e($id); ?>_totalFiles">0</span> <?php echo e(__('files')); ?>

                <span id="<?php echo e($id); ?>_filterInfo" class="ml-1 hidden sm:inline"></span>
                <span id="<?php echo e($id); ?>_paginationInfo" class="ml-2 text-xs hidden sm:inline"></span>
            </div>
            <div class="flex gap-3 w-full sm:w-auto order-1 sm:order-2">
                ...
                <button
                    type="button"
                    id="<?php echo e($id); ?>_selectButton"
                    onclick="confirmMediaSelection('<?php echo e($id); ?>')"
                    class="btn-primary flex-1 sm:flex-initial"
                    disabled
                >
                    <?php echo e($multiple ? __('Select Files') : __('Select')); ?>
    ...
    <div class="max-w-2xl max-h-[90vh] p-4" onclick="event.stopPropagation()">
        <div class="bg-gradient-to-br from-green-100 to-emerald-200 dark:from-green-900 dark:to-emerald-800 rounded-lg p-8 text-center">
            ...
            <div class="mb-6">
                ...
                <p class="text-green-600 dark:text-green-400 text-sm"><?php echo e(__('Audio Player')); ?></p>
            </div>
...
window.mediaModalTranslations = {
    copied: '<?php echo e(__('Copied')); ?>',
    urlCopied: '<?php echo e(__('URL copied to clipboard')); ?>',
    matching: '<?php echo e(__('matching')); ?>',
    available: '<?php echo e(__('available')); ?>',
    loaded: '<?php echo e(__('loaded')); ?>',
    of: '<?php echo e(__('of')); ?>',
    total: '<?php echo e(__('total')); ?>',
    allLoaded: '<?php echo e(__('all loaded')); ?>',
    loadMore: '<?php echo e(__('Load More')); ?>',
    items: '<?php echo e(__('items')); ?>',
    success: '<?php echo e(__('Success')); ?>',
    filesUploaded: '<?php echo e(__('Files uploaded successfully')); ?>',
    uploadFailed: '<?php echo e(__('Upload Failed')); ?>',
    uploadError: '<?php echo e(__('Upload Error')); ?>',
    failedToUpload: '<?php echo e(__('Failed to upload files')); ?>',
    loadingMore: '<?php echo e(__('Loading more files...')); ?>',
    size: '<?php echo e(__('Size')); ?>',
    duration: '<?php echo e(__('Duration')); ?>',
    format: '<?php echo e(__('Format')); ?>',
    unknown: '<?php echo e(__('Unknown')); ?>',
    pixels: '<?php echo e(__('pixels')); ?>',
    resolution: '<?php echo e(__('resolution')); ?>'
};
...
function setupActionButtons(modalId, file) {
    ...
    if (isImage) {
        ...
        fullViewButton.innerHTML = `
            ...
            <span><?php echo e(__('Listen')); ?></span>
        `;
    } else {
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\projects\php8\lara\resources\views/components/media-modal.blade.php ENDPATH**/ ?>