...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['soundEffect' => false, 'displayDuration' => 5000]));
...
foreach (array_filter((['soundEffect' => false, 'displayDuration' => 5000]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div
    ...
    x-data="{
        notifications: [],
        displayDuration: '<?php echo e($displayDuration); ?>',
        soundEffect: '<?php echo e($soundEffect); ?>',
...
<?php /**PATH D:\projects\php8\lara\resources\views/components/toast-notifications.blade.php ENDPATH**/ ?>