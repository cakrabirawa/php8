...
const distOutDir = path.resolve(__dirname, 'dist/build-test');
const devOutDir = path.resolve(__dirname, '../../public/build-test');

export default defineConfig({
    build: {
        outDir: isDistBuild ? distOutDir : devOutDir,
        emptyOutDir: true,
        // Write the manifest at the build-dir root (public/build-test/manifest.json)
